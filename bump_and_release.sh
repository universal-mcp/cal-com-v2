...
echo "Generating tools README for src/universal_mcp_cal_com_v2/app.py..."
universal_mcp readme src/universal_mcp_cal_com_v2/app.py

# Stage the changed file
git add pyproject.toml src/universal_mcp_cal_com_v2/README.md
